...
function setup() {
  ...
  gameOver = createSprite(width/2,height-280);
  ...
  invisibleGround = createSprite(200,height-140,400,10);
...
function draw() {
  ...
  textSize(20);
  fill("black");
  text("SCORE: "+score,height-60,width-680);
}

function spawnClouds() {
  //write code here to spawn the clouds
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width+5,200,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(width+5,height-165,10,40);
    //obstacle.debug = true;
